...
public class MediaFiles implements Parcelable {
    ...
    public MediaFiles(String id, String title, String displayName, String size, String duration, String path, String dateAddec) {
        this.id = id;
        this.title = title;
    ...
    public String getDateAddec() {
        return dateAdded;
    }

    public void setDateAddec(String dateAddec) {
        this.dateAdded = dateAddec;
    }
